...
const createStyles = (t: Palette) => StyleSheet.create({
  ...
  dialOuter: { borderWidth: 2, borderColor: t.accentBorder, backgroundColor: t.surfaceAlt, alignItems: "center", justifyContent: "center", shadowColor: t.glow, shadowOpacity: t.mode === "dark" ? 0.45 : 0.2, shadowRadius: 16, elevation: 6 },
  dialFace: { position: "absolute", borderWidth: 1, borderColor: t.borderStrong, backgroundColor: t.accentBg, alignItems: "center" },
  dialPointer: { position: "absolute", top: 8, width: 4, height: 22, borderRadius: 2, backgroundColor: t.accent, shadowColor: t.glow, shadowOpacity: 0.9, shadowRadius: 6, elevation: 3 },
  ...
  dialValue: { color: t.textPrimary, fontSize: 11, lineHeight: 15, fontWeight: "800", textAlign: "center", letterSpacing: 0.3 },
  runStatus: { alignSelf: "stretch", marginTop: 7, paddingHorizontal: 4, color: t.textSecondary, fontSize: 9, lineHeight: 12, fontWeight: "800", textAlign: "center", letterSpacing: 0.5 },
  ...
  iconButtonText: { color: t.accent, fontSize: 26, lineHeight: 28, fontWeight: "500", textShadowColor: t.glow, textShadowRadius: t.mode === "dark" ? 6 : 0, textShadowOffset: { width: 0, height: 0 } },
  ...
  sideButtonActive: { backgroundColor: t.primary, borderColor: t.primaryBorder, shadowColor: t.glow, shadowOpacity: t.mode === "dark" ? 0.5 : 0.22, shadowRadius: 10, elevation: 4 },
  sideButtonText: { color: t.textPrimary, fontSize: 10, lineHeight: 14, textAlign: "center", fontWeight: "800", letterSpacing: 0.5 },
  ...
  effortThumb: { position: "absolute", width: 18, height: 18, borderRadius: 9, backgroundColor: "#ffffff", borderWidth: 3, borderColor: t.accentBorder, shadowColor: t.glow, shadowOpacity: 0.75, shadowRadius: 8, elevation: 4 },
  ...
  unifiedPanel: { flex: 1, minHeight: 0, borderRadius: 15, borderWidth: 1, borderColor: t.borderStrong, backgroundColor: t.surfaceAlt, overflow: "hidden" },
  ...
  mainTab: { color: t.textMuted, fontSize: 12, fontWeight: "900", letterSpacing: 1 },
  ...
  input: { flex: 1, minHeight: 40, color: t.textPrimary, fontSize: 13, lineHeight: 18, textAlignVertical: "top", padding: 0, letterSpacing: 0.2 },
  inputActions: { flexDirection: "row", justifyContent: "flex-end", gap: 7 },
  send: { backgroundColor: t.primary, width: 48, alignItems: "center", paddingVertical: 8, borderRadius: 9, borderWidth: 1, borderColor: t.primaryBorder, shadowColor: t.glow, shadowOpacity: t.mode === "dark" ? 0.45 : 0.2, shadowRadius: 8, elevation: 3 },
  stop: { backgroundColor: t.declineBtn, width: 48, alignItems: "center", paddingVertical: 8, borderRadius: 9, borderWidth: 1, borderColor: t.errorBorder },
  disabled: { opacity: 0.35 },
  actionText: { color: "#ffffff", fontSize: 10, fontWeight: "900" },
  tab: { color: t.textMuted, fontSize: 10, fontWeight: "800", letterSpacing: 0.8 },
  tabActive: { color: t.accent, textShadowColor: t.glow, textShadowRadius: t.mode === "dark" ? 6 : 0, textShadowOffset: { width: 0, height: 0 } },
  output: { flex: 1 },
  outputContent: { padding: 10 },
  mono: { color: t.textSecondary, fontFamily: "monospace", fontSize: 10, lineHeight: 15, letterSpacing: 0.3 },
  ...
  errorBox: { position: "absolute", left: 170, right: 170, bottom: 10, paddingHorizontal: 10, paddingVertical: 7, borderRadius: 9, borderWidth: 1, borderColor: t.errorBorder, backgroundColor: t.errorBg, shadowColor: t.danger, shadowOpacity: t.mode === "dark" ? 0.3 : 0.1, shadowRadius: 10, elevation: 4 },
  errorText: { color: t.errorText, fontSize: 8, letterSpacing: 0.3 },
});
