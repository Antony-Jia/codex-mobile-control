...
const createStyles = (t: Palette) => StyleSheet.create({
  ...
  headingText: { color: t.textSecondary, fontSize: 10, fontWeight: "900", letterSpacing: 1.5 },
  hint: { color: t.textFaint, fontSize: 8, marginTop: 2 },
  headingActions: { flexDirection: "row", gap: 14 },
  headingButton: { color: t.accentDim, fontSize: 9, fontWeight: "800" },
  headingButtonStrong: { color: t.accent, fontSize: 9, fontWeight: "900" },
  list: { gap: GAP, paddingRight: 42, paddingVertical: 2 },
  ...
  selected: { backgroundColor: t.accentBg, borderColor: t.accentBorder, borderWidth: 2, shadowColor: t.glow, shadowOpacity: t.mode === "dark" ? 0.4 : 0.2, shadowRadius: 10, shadowOffset: { width: 0, height: 0 }, elevation: 4 },
  light: { width: 6, alignSelf: "stretch", borderRadius: 5, marginLeft: 7, shadowOpacity: 0.9, shadowRadius: 8, elevation: 6 },
  number: { width: 30, height: 30, marginHorizontal: 8, borderRadius: 15, backgroundColor: t.surfaceAlt, borderWidth: 1, borderColor: t.border, alignItems: "center", justifyContent: "center" },
  numberText: { color: t.textSecondary, fontSize: 12, fontWeight: "800" },
  text: { flex: 1, minWidth: 0 },
  title: { color: t.textPrimary, fontWeight: "700", fontSize: 13 },
  project: { color: t.textMuted, fontSize: 9, marginTop: 5, textTransform: "uppercase" },
  ...
  openingText: { color: t.accent, fontSize: 7, fontWeight: "900" },
});
